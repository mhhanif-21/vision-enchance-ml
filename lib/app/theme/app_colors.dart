...
class AppColors {
  ...
  static const Color primaryFixed = Color(0xFFE3E2DF);
  static const Color primaryFixedDim = Color(0xFFC7C7C3);
  ...
  static const Color secondaryFixed = Color(0xFFC7E9E7);
  static const Color secondaryFixedDim = Color(0xFFACCDCB);
  ...
  static const Color tertiaryFixed = Color(0xFFE5E1E6);
  static const Color tertiaryFixedDim = Color(0xFFC9C5CA);
  ...
  // --- Accent (Teal highlight from Stitch) ---
