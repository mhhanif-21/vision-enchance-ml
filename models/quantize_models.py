...
if __name__ == "__main__":
    # Tentukan path input dinamis berbasis lokasi script saat ini
    script_dir = os.path.dirname(os.path.abspath(__file__))
    models = [
        os.path.join(script_dir, "deblurring_nafnet_2025may.onnx"),
        os.path.join(script_dir, "low_light_enhancement.onnx")
    ]
